...
def test_v3_plugins_keep_stable_identity_and_versions():
    assert _class_name_and_version(ROOT / "plugins.v3/autosubv3/__init__.py") == ("AutoSubv3", "4.0.0")
...
def test_v3_index_and_v2_opt_out_are_consistent():
    ...
    for plugin_id, version in (("AutoSubv3", "4.0.0"), ("SubtitleManualUpload", "1.0.0")):
