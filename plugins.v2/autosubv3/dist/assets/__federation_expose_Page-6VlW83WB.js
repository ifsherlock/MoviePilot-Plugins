...
const {createTextVNode:_createTextVNode$3,resolveComponent:_resolveComponent$4,withCtx:_withCtx$3,createVNode:_createVNode$3,openBlock:_openBlock$4,createBlock:_createBlock$4} = await importShared('vue');
...
const {renderList:_renderList$1,Fragment:_Fragment$1,openBlock:_openBlock$3,createElementBlock:_createElementBlock$2,toDisplayString:_toDisplayString$2,createTextVNode:_createTextVNode$2,resolveComponent:_resolveComponent$3,withCtx:_withCtx$2,createBlock:_createBlock$3} = await importShared('vue');
              ...
              return (_openBlock$2(), _createElementBlock$1("div", {
                ...
                _createElementVNode$2("div", _hoisted_5, [
                  ...
                  _createElementVNode$2("div", _hoisted_9, [
                    ...
                    (sourceText(task))
                      ? (_openBlock$2(), _createElementBlock$1("span", _hoisted_10, _toDisplayString$1(sourceText(task)), 1))
                      : _createCommentVNode$1("", true),
                    (task.output_name)
                      ? (_openBlock$2(), _createElementBlock$1("span", _hoisted_11, "输出：" + _toDisplayString$1(task.output_name), 1))
                      : _createCommentVNode$1("", true),
                  ...
                  (task.status === 'failed' && task.message)
                    ? (_openBlock$2(), _createBlock$2(_component_VTooltip, {
                        ...
                        activator: _withCtx$1(({ props: tooltipProps }) => [
                          _createElementVNode$2("div", _mergeProps({ ref_for: true }, tooltipProps, { class: "task-message task-message-error" }), _toDisplayString$1(task.message), 17)
                        ]),
                        default: _withCtx$1(() => [
                          _createElementVNode$2("span", null, _toDisplayString$1(task.message), 1)
                        ]),
                        _: 2
                      }, 1024))
                    : (task.message)
                      ? (_openBlock$2(), _createElementBlock$1("div", _hoisted_12, _toDisplayString$1(task.message), 1))
                      : _createCommentVNode$1("", true)
                ]),
